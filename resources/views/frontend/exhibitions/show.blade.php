    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-8">
            ...
            <p class="text-muted mb-3">
                <i class="bi bi-geo-alt me-1"></i>{{ $exhibition->venue }}, {{ $exhibition->city }}, {{ $exhibition->country }}<br>
                <i class="bi bi-calendar3 me-1"></i>{{ $exhibition->start_date->format('d M Y') }} - {{ $exhibition->end_date->format('d M Y') }}
            </p>
