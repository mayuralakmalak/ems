...
class ExhibitionController extends Controller
{
    ...
    public function storeStep3(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'visitor_early_bird_end_date' => 'nullable|date',
            'visitor_early_bird_fee' => 'nullable|numeric|min:0',
            'visitor_standard_end_date' => 'nullable|date',
            'visitor_standard_fee' => 'nullable|numeric|min:0',
            'visitor_last_minute_end_date' => 'nullable|date',
            'visitor_last_minute_fee' => 'nullable|numeric|min:0',
            'delegate_free_count' => 'nullable|integer|min:0',
            'delegate_additional_fee' => 'nullable|numeric|min:0',
            'member_fee' => 'nullable|numeric|min:0',
            'vip_registration_fee' => 'nullable|numeric|min:0',
        ...
        $updateData = [
            ...
            'visitor_early_bird_end_date' => $request->visitor_early_bird_end_date ?: null,
            'visitor_early_bird_fee' => $request->filled('visitor_early_bird_fee') ? $request->visitor_early_bird_fee : null,
            'visitor_standard_end_date' => $request->visitor_standard_end_date ?: null,
            'visitor_standard_fee' => $request->filled('visitor_standard_fee') ? $request->visitor_standard_fee : null,
            'visitor_last_minute_end_date' => $request->visitor_last_minute_end_date ?: null,
            'visitor_last_minute_fee' => $request->filled('visitor_last_minute_fee') ? $request->visitor_last_minute_fee : null,
            'delegate_free_count' => $request->filled('delegate_free_count') ? (int) $request->delegate_free_count : 2,
            'delegate_additional_fee' => $request->filled('delegate_additional_fee') ? $request->delegate_additional_fee : null,
            'member_fee' => $request->filled('member_fee') ? $request->member_fee : null,
            'vip_registration_fee' => $request->filled('vip_registration_fee') ? $request->vip_registration_fee : null,
        ];
